...
#ifndef ADAFRUITNEOPIXEL_H
#define ADAFRUITNEOPIXEL_H
...
class AdafruitNeoPixel {

 public:

  // Constructor: number of LEDs, pin number, LED type
  AdafruitNeoPixel(uint16_t n, uint8_t p=6, uint8_t t=NEO_GRB + NEO_KHZ800);
  ~AdafruitNeoPixel();
